...
describe User do
  ...
  before { @user = User.new(name: "Example User", email: "user@example.com", username:"example", password: "foobar", password_confirmation: "foobar") }
  ...
  describe "post associations" do
    ...
    describe "status" do
      ...
      before do
        ...
        3.times { followed_user.posts.create!(title: "Lorem ipsum", youtube_id: "QtvbSqp71sA", category: "Other") }
      end
